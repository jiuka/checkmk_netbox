...
def parse_netbox_report(string_table):
    parsed = {}
...
register.agent_section(
    name = "netbox_report",
    parse_function = parse_netbox_report,
)


def discover_netbox_report(section):
    for name in section:
        yield Service(item=name)


def check_netbox_report(item, params, section):
...
register.check_plugin(
    ...
    discovery_function = discover_netbox_report,
    check_function = check_netbox_report,
    check_ruleset_name = "netbox_report",
